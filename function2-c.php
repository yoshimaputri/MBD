...
<body id="body-index">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
      <br><br><br>
      <button class="btn btn-danger btn-lg" style="font-size: 30px;">
        <?php
            ...
            $value1 = $_POST['userrname'];
            $sql = "SELECT DISTINCT total_book('$value1') AS `Total Transaction` FROM booking;";
            $result = $link->query($sql);

            if ($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
              echo $value1 . " - Total Transaction : " . $row["Total Transaction"];
             }
            } else{
              echo "0 result";
            }
